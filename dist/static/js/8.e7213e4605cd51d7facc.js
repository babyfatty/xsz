...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('tr', [_c('td', [_vm._v("\n\t\t\t\t\t\t" + _vm._s(order.uname) + "\n\t\t\t\t\t")]), _vm._v(" "), _c('td', [_vm._v("\n\t\t\t\t\t\t" + _vm._s(order.chosen) + "\n\t\t\t\t\t")]), _vm._v(" "), _c('td', [_vm._v("\n\t\t\t\t\t\t" + _vm._s(order.amount) + "\n\t\t\t\t\t")]), _vm._v(" "), _c('td', [_vm._v("\n\t\t\t\t\t\t" + _vm._s(JSON.parse(order.adress).name) + "，" + _vm._s(JSON.parse(order.adress).tel) + "，\n\t\t\t\t\t\t" + _vm._s(JSON.parse(order.adress).city) + "市" + _vm._s(JSON.parse(order.adress).district) + "区，\n\t\t\t\t\t\t" + _vm._s(JSON.parse(order.adress).detail) + "\n\t\t\t\t\t")]), _vm._v(" "), _c('td', [_c('span', [_vm._v(_vm._s(new Date(order.createdAt).getFullYear()))]), _vm._v("/"), _c('span', [_vm._v(_vm._s(new Date(order.createdAt).getMonth() + 1))]), _vm._v("/"), _c('span', [_vm._v(_vm._s(new Date(order.createdAt).getDate()))]), _vm._v("-"), _c('span', [_vm._v(_vm._s(new Date(order.createdAt).getHours() > 9 ? new Date(order.createdAt).getHours() : "0" + new Date(order.createdAt).getHours()))]), _vm._v(":"), _c('span', [_vm._v(_vm._s(new Date(order.createdAt).getMinutes() > 9 ? new Date(order.createdAt).getMinutes() : "0" + new Date(order.createdAt).getMinutes()))]), _vm._v(":"), _c('span', [_vm._v(_vm._s(new Date(order.createdAt).getSeconds() > 9 ? new Date(order.createdAt).getSeconds() : "0" + new Date(order.createdAt).getSeconds()))])]), _vm._v(" "), _c('td', [_vm._v("\n\t\t\t\t\t\t" + _vm._s(order.transID) + "\n\t\t\t\t\t")])])
  }))])])
...
//# sourceMappingURL=8.e7213e4605cd51d7facc.js.map